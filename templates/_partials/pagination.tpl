...
<nav class="pagination">
  <div class="col">
    {block name='pagination_summary'}
      {l s='Showing %from%-%to% of %total% reference(s)' d='Shop.Theme.Catalog' sprintf=['%from%' => $pagination.items_shown_from ,'%to%' => $pagination.items_shown_to, '%total%' => $pagination.total_items]}
    {/block}
  </div>
  <div class="col">
